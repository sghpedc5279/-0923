...
它不是把古文翻译给你看，而是给你工具，让你自己探索原始内容。
• 从一个人物出发，看他的关系网，沿线索走进他那个时代，在地图上找到战役发生地——读史方式从"翻一本书"变成"在历史数据库里探索"。
难的不是画图，是消歧。普通文本处理会把"赵籍""赵侯""赵烈侯"当成三个人，关系网直接乱成一团。作者用 Union-Find（并查集）算法把同一人的不同称呼合并成一个节点，再处理"人地分离"（"赵"到底是人名还是国名）。高德地图地理编码负责把古地名映射到现代坐标。这层语言本身的密度，才是读史书真正拦人的东西。
